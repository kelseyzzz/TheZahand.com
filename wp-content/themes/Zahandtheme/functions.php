...
function load_scripts() {
    wp_enqueue_style( 'animate-style', '//cdn.jsdelivr.net/npm/animate.css@3.5.2/animate.min.css' );
    ...
    wp_enqueue_script( 'script-waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.js', array(), '1.0.0', true );
